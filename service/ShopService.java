...
public class ShopService {
    final CatalogDataSource catalogDataSource; //Используеться для возвращения каталога
    final CartDataSource cartDataSource; //Используеться для возвращения корзины и для добовления товара в корзину
