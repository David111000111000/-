...
public class AddToCartListener implements MouseListener {
    ...
    private final JButton back; //Кнопка которая перебрасывает нас на главный экран
    private final ShopService shopService; // Кнопочка для добавления товара в корзину (shopService.addToCart)
    ...
    @Override
    /*Метод mouseClicked(MouseEvent e) выполняет определенные действия
    в ответ на клик мышью на компоненте или элементе интерфейса.*/
    public void mouseClicked(MouseEvent e) {
        panel.removeAll();
        panel.setVisible(false);
        panel.setVisible(true);
        //Добавляем на панель все кнопки(AddToCartView)
        ...
        //Обработчик события кнопки Enter у метода AddToCart
